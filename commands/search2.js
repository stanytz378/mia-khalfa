...
gmd(
  {
    pattern: "ggleimage",
    aliases: ["googleimage", "gimage", "ggleimagesearch", "googleimagesearch", "gm"],
    category: "search",
    react: "🖼️",
...
gmd(
  {
    pattern: "unsplash",
    aliases: ["unsplashphotos", "unsplashsearch", "uns"],
    category: "search",
    react: "📷",
...
gmd(
  {
    pattern: "wattpad",
    aliases: ["watt", "wattsearch", "wattpadsearch", "str"],
    category: "search",
    react: "📚",
