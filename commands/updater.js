const { gmd, copyFolderSync } = require("../stanytz");
...
gmd(
    ...
    async (from, Gifted, conText) => {
        ...
        try {
            ...
            const zipPath = path.join(__dirname, "..", "mia-khalifa-main.zip"); // Replace this  with your bot name and branch if you're 
            ...
            const sourcePath = path.join(extractPath, "mia-khalifa-main"); // Replace this  with your bot name and branch if you're cloning
            const destinationPath = path.join(__dirname, "..");

            const excludeList = [
                ".env",
                "stanytz/database/database.db",
                "stanytz/session/session.db",
            ];
