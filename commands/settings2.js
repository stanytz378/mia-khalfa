const { gmd } = require("../stanytz/gmdCmds");
const { getSetting, setSetting } = require("../stanytz/database/settings");
const {
  getGroupSetting,
  setGroupSetting,
...
const { clearAllSudo, getSudoNumbers } = require("../black_hat/database/sudo");
const {
  getAllUsersNotes,
  deleteNoteById,
  updateNoteById,
